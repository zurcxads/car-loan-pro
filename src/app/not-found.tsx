            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {quickLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white hover:bg-gray-50 border border-gray-200 hover:shadow-sm transition-all active:scale-[0.98]"
                >
