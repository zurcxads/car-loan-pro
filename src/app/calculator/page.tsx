    ...
    <div className="min-h-screen bg-white ">
            ...
            <motion.div variants={fadeUp} className="lg:col-span-3 rounded-2xl border border-gray-200  bg-white  shadow-sm p-8">
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-3">
                  <label htmlFor={vehiclePriceId} className="text-sm text-gray-700  font-medium">Vehicle Price</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-32 pl-7 pr-3 py-2 bg-gray-50  border border-gray-200  rounded-lg text-sm text-right text-gray-900  focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                    />
                  </div>
                </div>
                <input
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-3">
                  <label htmlFor={downPaymentId} className="text-sm text-gray-700  font-medium">Down Payment</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">$</span>
                    <input
                      id={downPaymentId}
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-3">
                  <label htmlFor={creditScoreId} className="text-sm text-gray-700  font-medium">Credit Score</label>
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-20 px-3 py-2 bg-gray-50  border border-gray-200  rounded-lg text-sm text-right text-gray-900  focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                    />
                    <span className="text-xs text-gray-600 ">({creditScoreLabel(creditScore)})</span>
                  </div>
                </div>
                <input
                  type="range"
              ...
              {/* Loan Term */}
              <div>
                <div className="text-sm text-gray-700  font-medium block mb-3">Loan Term</div>
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            <motion.div variants={fadeUp} className="text-center mb-8">
              ...
              <p className="text-gray-600  text-sm">See how your payments break down over time</p>
            </motion.div>
            <motion.div variants={fadeUp}>
              <button
                type="button"
                onClick={() => setShowAmortization(!showAmortization)}
                className="w-full mb-4 px-6 py-3 bg-gray-100  hover:bg-gray-200  text-gray-900  text-sm font-medium rounded-xl transition-colors flex items-center justify-between focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
              ...
              {showAmortization && (
                <div id="amortization-schedule" className="rounded-2xl border border-gray-200  bg-white  overflow-hidden">
      ...
      <section className="py-24 px-6 bg-gray-50 ">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="max-w-2xl mx-auto text-center">
          ...
          <motion.p variants={fadeUp} className="text-gray-600  mb-10">These are estimates. Apply to see actual offers from competing lenders.</motion.p>
          <motion.div variants={fadeUp}>
