  ...
  useEffect(() => {
    ...
    fetch('/api/dashboard')
      ...
      .then(data => {
        ...
        setProfile({
          name: `${data.data.application.borrower.firstName} ${data.data.application.borrower.lastName}`,
          email: data.data.application.borrower.email || '',
          phone: data.data.application.borrower.phone || '',
        });
        setLoading(false);
      })
      .catch(() => {
