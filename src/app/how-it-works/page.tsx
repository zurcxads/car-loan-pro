...
const steps = [
  {
    ...
    desc: 'Fill out a single application in about 2 minutes. We only need basic info — no dealer visits, no phone calls, no obligation. Do this BEFORE going to any dealership, so you walk in with power.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Your profile is matched to our network of lenders who compete for your business in real-time. More competition means better rates for you — not the dealer. One soft pull, multiple instant offers.',
    icon: (
      <svg className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    num: '03',
    title: 'Choose Your Offer (instant)',
    desc: 'Review multiple offers side-by-side, compare APRs, terms, and monthly payments. Pick the best deal and get your pre-approval letter. Walk into any dealership with financing locked in.',
    icon: (
      <svg className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    num: '04',
    title: 'Shop With Confidence (on your schedule)',
    desc: 'Armed with pre-approval, visit dealerships on your own time. No pressure, no finance office runaround. You already have the financing — just pick your car.',
    icon: (
      <svg className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    details: [
      'Pre-approved with a blank check',
...
const trustBadges = [
  ...
  { Icon: CheckCircle, title: 'One Soft Pull', desc: 'No credit impact, unlike shopping at dealers' },
  { Icon: Lock, title: 'Instant Offers', desc: 'Multiple lenders compete in real-time' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 px-6">
        <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-3xl mx-auto text-center">
          ...
          <motion.p variants={fadeUp} className="mt-6 text-lg text-gray-500 max-w-xl mx-auto leading-relaxed font-light">
            At a dealership, this takes 3-5 visits. With us, it takes one coffee break. Total time: under 5 minutes from application to pre-approval.
          </motion.p>
        </motion.div>
      </section>
      ...
      <section className="py-16 px-6">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="max-w-3xl mx-auto">
          <div className="rounded-2xl bg-blue-50 border border-blue-200 p-8 sm:p-10 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">One Soft Pull vs Multiple Hard Pulls</h2>
            <p className="text-gray-600 max-w-lg mx-auto leading-relaxed">
              Traditional shopping means applying at multiple lenders (bank, credit union, dealer) — each one hits your credit with a hard pull. We use <strong>one soft inquiry</strong> to match you with multiple lenders at once. Zero credit impact until you choose an offer.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <section className="py-24 px-6">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="max-w-2xl mx-auto text-center">
          <motion.h2 variants={fadeUp} className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Ready to skip the dealership runaround?</motion.h2>
          <motion.p variants={fadeUp} className="text-gray-500 mb-10">Takes about 2 minutes. Save 15+ hours vs traditional financing. No credit impact.</motion.p>
