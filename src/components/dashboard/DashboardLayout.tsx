        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex gap-1 -mb-px overflow-x-auto">
            {tabs.map(tab => (
              <Link
                key={tab.key}
                href={tab.key === 'overview' ? '/dashboard' : `/dashboard?tab=${tab.key}`}
                className={`flex items-center gap-2 px-4 py-3.5 text-sm font-medium border-b-2 transition-colors duration-200 whitespace-nowrap ${
                  activeTab === tab.key
