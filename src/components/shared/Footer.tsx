    ...
    <footer className="bg-white dark:bg-zinc-950 border-t border-gray-200 dark:border-zinc-800">
      ...
      <div className="border-b border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-gray-700 dark:text-zinc-300">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          {/* Product */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-zinc-100 mb-4">Product</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-zinc-100 mb-4">Company</h3>
            <ul className="space-y-3 text-sm text-gray-600 dark:text-zinc-400">
          ...
          {/* Legal */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-zinc-100 mb-4">Legal</h3>
            <ul className="space-y-3 text-sm text-gray-600 dark:text-zinc-400">
          ...
          {/* Partners */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-zinc-100 mb-4">Partners</h3>
            <ul className="space-y-3 text-sm text-gray-600 dark:text-zinc-400">
              <li><Link href="/lender/onboard" className="hover:text-blue-600 transition-colors">For Lenders</Link></li>
              <li><Link href="/dealer/onboard" className="hover:text-blue-600 transition-colors">For Dealers</Link></li>
        ...
        <div className="border-t border-gray-200 dark:border-zinc-800 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500 dark:text-zinc-400">
